        ...
        <div class="course_list">
          <ul>
            <li>
              ...
              <a :href="practicusIntensive2022_2" target="_blank" class="global_cta">Compre aqui</a>
            </li>
      ...
      <section>
        ...
        <div class="method_list">
          <ul>
            ...
            <li>
              <h2 class="title">Mentoria Practicus</h2>
              <p class="description">
                Treinamento semanal de estação prática
              </p>
            </li>
          </ul>
        </div>
